...
def final_strategy(score, opponent_score):
    ...
    *** The point of this strategy is to calculate the expectation of each rolling. 
        So if the expectation is higher than the free bacon points, there is a SHOT. 
        But if you already have high scores, you don't need to take the risk. Second,
        you can set up your opponent, force him to swap with you. Third, be careful 
        when taking free bacon points, if the taking free points may lower your scores
        by swaping, don't take it. ***
    """
    # BEGIN Question 10
    # 1 0
    setup = False
