...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # BEGIN Question 1
    ratings = [] # the ratings of this restaurant 
    for review in reviews:
        if review_restaurant_name(review) == name: # if the review belongs to the restaurant, index its rating for this restaurant.
